...
public class TestSeriesFragment3 extends Fragment {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            Log.i("Temp TSF3", "" + response.toString());
//                          ;
    ...
    private void prepareAlbums(JSONArray temp) throws JSONException {
        ...
        for (int i = 0; i < temp.length(); i++) {
            ...
            Album a=  new Album(id, name,heading,url,details,"http://magnusias.com/"+img,2002);
            albumList.add(a);
