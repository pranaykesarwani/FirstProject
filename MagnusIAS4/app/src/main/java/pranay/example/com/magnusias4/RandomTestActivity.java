...
public class RandomTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */final ArrayAdapter<RandomTest> adapter = new RandomTestActivity.Adapter();

        listView = (ListView) findViewById(R.id.random_test_list_0);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for(int i = 0;i<temp.length(); i++){
                                ...
                                dataFeed.add(new RandomTest
                                        (question_num,question,options,answers,description,question_type,pdf,video_url,hints));
    ...
    private class  Adapter extends  ArrayAdapter<RandomTest> {
        ...
        public Adapter() {
            super(getApplicationContext(), R.layout.random_exam_test,dataFeed);
        }
