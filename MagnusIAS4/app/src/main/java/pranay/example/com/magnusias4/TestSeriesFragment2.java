...
public class TestSeriesFragment2 extends Fragment {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONArray dataArray = response.getJSONArray("test-sub-menu");
...
//                          ;
    ...
    private void prepareAlbums(JSONArray temp) throws JSONException {
        ...
        for (int i = 0; i < temp.length(); i++) {
            ...
            String second_menu = buffer.getString("second_menu");
